...
WebDriver driver;
	...
	@Test
	public void validUserShouldBeAbleToAddCustomerAndConfirm() {
		...
		ListContactPage listContactPage = PageFactory.initElements(driver, ListContactPage.class);
		String variable = listContactPage.storeUsernameCreated();
		listContactPage.clickListCustomersTab();
		listContactPage.insertNameIntoSearchBox(variable);
		listContactPage.validateName(variable);
